...
<header class="site-header size-lg text-center" style="background-image: url({{ ('assets/img/bg-banner1.jpg') }})">
    <div class="container">
        <div class="col-xs-12">
            <br><br>
            <h2>We offer <mark>{{ $totalJobs }} +</mark> job vacancies right now!</h2>
        ...
        <div class="container">
            ...
            <div class="row item-blocks-connected">
                ...
                @foreach($visits as $visit)
                    <div class="col-xs-12">
                        <a class="item-block" href="{{ '/job/' . $visit->notification->slug }}">
                            <header>
                                <img src="{{ $visit->notification->employer->image }}" alt="">
                                <div class="hgroup">
                                    <h4>{{ $visit->notification->title }}</h4>
                                    <h5>{{ $visit->notification->employer->name }}</h5>
                                </div>
                                <div class="header-meta">
                                    @if(!empty($visit->notification->employer->city) && !empty($visit->notification->employer->country))
                                        <span class="location"> {{ $visit->notification->employer->city . ", " . $visit->notification->employer->country }}</span>
                                    @else
                                        <span class="location">Tiranë, Shqipëri</span>
                                    @endif
            ...
            <br><br>
            <p class="text-center"><a class="btn btn-info" href="/jobs">Browse all jobs</a></p>
        </div>
    </section>
    <!-- END Recent jobs -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="counter col-md-3 col-sm-6">
                    <p><span data-from="0" data-to="{{ $totalJobs }}"></span>+</p>
                    <h6>Jobs</h6>
                </div>
                ...
                <div class="counter col-md-3 col-sm-6">
                    <p><span data-from="0" data-to="{{ $totalEmployers }}"></span>+</p>
                    <h6>Company</h6>
                </div>
            </div>
